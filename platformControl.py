...
class PlatformControl(QtWidgets.QWidget):
    def __init__(self, parent, main):
        ...
        self.pump2.pumpModelCombo.setCurrentText(self.pumpsTuple[1])
        self.pump2.formatWidget(pump=self.pumpsTuple[1])
        ...
        self.pump9.pumpModelCombo.setCurrentText(self.pumpsTuple[2])
        ...
        self.pump12.pumpModelCombo.setCurrentText(self.pumpsTuple[2])
        ...
        self.pump13.pumpModelCombo.setCurrentText(self.pumpsTuple[4])
        ...
        self.valvesBox.setMaximumWidth(1500)
        ...
        self.valve3 = vw.ValveControl(self, valveName="Kinetics collector")
        ...
        self.valve4.valveTypeCombo.setCurrentText(self.valvesTuple[2])
        self.valve4.formatWidget(valve=self.valvesTuple[2])
        self.valvesLayout.addWidget(self.valve4, 0, 3, QtCore.Qt.AlignLeft)

        self.valve5 = vw.ValveControl(self, valveName="Outlet")
        self.valve5.valveTypeCombo.setCurrentText(self.valvesTuple[0])
        self.valve5.formatWidget(valve=self.valvesTuple[0])
